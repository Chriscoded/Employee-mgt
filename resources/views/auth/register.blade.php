            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="join_date" class="col-md-4 col-form-label text-md-end">{{ __('Join date') }}</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="job_type" type="text" class="form-control @error('job_type') is-invalid @enderror" name="job_type" value="{{ old('job_type') }}" required autocomplete="join_date">
